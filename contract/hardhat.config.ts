...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    // Polygon (Primary chain for escrow)
    polygon: {
    ...
    // Ethereum (Source chain for funding)
    mainnet: {
    ...
    // Arbitrum (Source chain for funding)
    arbitrum: {
    ...
    // Optimism (Source chain for funding)
    optimism: {
